...
public:
  ...
  enum {
    ...
    RuleDeclarations = 4, RuleVariable_decl = 5, RuleData = 6, RuleArray = 7, 
    RuleType = 8, RuleStatements = 9, RuleStatement = 10, RuleElseStmt = 11, 
  ...
  class  CorcheteContext : public ExprContext {
  public:
    CorcheteContext(ExprContext *ctx);
