...
public:
  ...
  virtual void enterParameter(AslParser::ParameterContext *ctx) = 0;
  virtual void exitParameter(AslParser::ParameterContext *ctx) = 0;
  ...
  virtual void enterData(AslParser::DataContext *ctx) = 0;
  virtual void exitData(AslParser::DataContext *ctx) = 0;
  ...
  virtual void enterElseStmt(AslParser::ElseStmtContext *ctx) = 0;
  virtual void exitElseStmt(AslParser::ElseStmtContext *ctx) = 0;
  ...
  virtual void enterLogical(AslParser::LogicalContext *ctx) = 0;
  virtual void exitLogical(AslParser::LogicalContext *ctx) = 0;

  virtual void enterCorchete(AslParser::CorcheteContext *ctx) = 0;
  virtual void exitCorchete(AslParser::CorcheteContext *ctx) = 0;
